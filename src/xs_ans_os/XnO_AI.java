...
public class XnO_AI {
    ...
    public static void main(String[] args) {
        ...
        int row, col; //used for storing user input
    ...
    public static void compPlayer(char symbol)
    {
        
    }
    
    public boolean twoInRow(char symbol)
    {
        //check rows
        for (int i = 0; i < board.length; i++) {
           if(board[i][2]==' '&&board[i][0]!=symbol&&board[i][0]==symbol)
           {
               board[i][2]=symbol;
               return true;
           }                      
    ...
    public boolean tryTakeWinnindRow()
    {
        return true;
    }
